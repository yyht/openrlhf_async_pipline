...
def main(script_args: ScriptArguments):
    ...
    llm = LLM(
        ...
        worker_extension_cls="openrlhf.async_pipline.vllm_serve.WeightSyncWorkerExtension",
    )
    ...
    async def generate(request: GenerateRequest):
        ...
        if request.prompts:
            ...
            all_outputs = llm.generate(sampling_params=sampling_params, prompt_token_ids=request.prompt_token_ids)
        return all_outputs
