...
MATH_KEY = os.getenv('MATH_KEY', 'score')
...
import os
tokenizer = AutoTokenizer.from_pretrained(os.getenv('PRETRAIN', 'YOUR_MODEL_PATH'))
        ...
        async with Timer("##ASYNC SCORE TI MING WITH MATH##"):
            try:
                results = await asyncio.gather(
                    ...
                    math_verify_server(prompt, resp, label, MATH_KEY),
