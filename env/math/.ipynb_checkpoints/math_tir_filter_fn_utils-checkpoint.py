...
def exp_filter_fn(exp, sample, **kwargs):
    ...
    code_filter = sample.rewards[0]['code_count'][0] != sample.rewards[0]['output_count'][0] or sample.rewards[0]['code_count'][0] != sample.rewards[0]['partial_code_count'][0] or sample.rewards[0]['code_exection_times'][0] != sample.rewards[0]['output_count'][0]
