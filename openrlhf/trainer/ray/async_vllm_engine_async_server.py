...
from openrlhf.async_pipline.process_request import GenerateRequest, process_batch_requests_ray
import sys, os, json
        ...
        if self.actor_counter == self.num_actors:
            ...
            if len(requests_of_ids) > 0:
                ...
                for start_idx, batch in batches:
                    ...
                    responses_ray.append(process_batch_requests_ray.remote(url, start_idx, batch, env_func=env_func, tokenizer=tokenizer))
    ...
    async def add_env_pipline_requests(self, prompt_idx, actor_rank, *, sampling_params, prompt_token_ids, 
        ...
        if self.actor_counter_dict[prompt_idx] == self.num_actors:
            ...
            if len(requests_of_ids) > 0:
                ...
                for start_idx, batch in batches:
                    env_func = batch[0].env_func
                    responses_ray.append(process_batch_requests_ray(url, start_idx, batch, env_func=env_func, tokenizer=tokenizer))
